 ...
 */
export declare class VideoPlayer extends SharedObject<PlayerEvents> {
  /**
...
export type PlayerEvents = {
   ...
   */
  statusChange: (oldStatus: PlayerStatus, newStatus: PlayerStatus, error: PlayerError) => void;
  /**
   * Handler for an event emitted when the player starts or stops playback.
   */
  playingChange: (oldIsPlaying: boolean, newIsPlaying: boolean) => void;
  /**
   * Handler for an event emitted when the `playbackRate` property of the player changes.
   */
  playbackRateChange: (oldPlaybackRate: number, newPlaybackRate: number) => void;
  /**
   * Handler for an event emitted when the `volume` property of the player changes.
   */
  volumeChange: (oldVolume: VolumeEvent, newVolume: VolumeEvent) => void;
  /**
   ...
   */
  sourceChange: (previousSource: VideoSource, newSource: VideoSource) => void;
};
